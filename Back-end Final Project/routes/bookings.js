...
router.get('/', (req, res) => {
  try {
    const { userId, checkinDate, numberOfGuets } = req.query
    const bookings = getBookings(userId, checkinDate, numberOfGuets)
...
router.put('/:id', (req, res) => {
  try {
    ...
    const updatedBooking = updateBookingsById(
      id,
      userId,
      propertyId,
      checkinDate,
...
router.delete('/:id', (req, res) => {
  try {
    const { id } = req.params
    const deletedBooking = deleteBookings(id)
