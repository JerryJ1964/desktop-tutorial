...
var _createBookings = _interopRequireDefault(require("../services/bookings/createBookings.js"));

var _getBookingsById = _interopRequireDefault(require("../services/bookings/getBookingsById.js"));

var _updateBookingsById = _interopRequireDefault(require("../services/bookings/updateBookingsById.js"));

var _deleteBookings = _interopRequireDefault(require("../services/bookings/deleteBookings.js"));
...
router.post('/', _advancedAuth["default"], function (req, res) {
  try {
    ...
    var newBookings = (0, _createBookings["default"])(id, userId, propertyId, checkinDate, checkoutDate, numberOfGuests, bookingStatus);
...
router.get('/:id', function (req, res) {
  try {
    ...
    var bookings = (0, _getBookingsById["default"])(id);
...
router.put('/:id', _advancedAuth["default"], function (req, res) {
  try {
    ...
    var updateBookingsById = (0, _updateBookingsById["default"])(id, userId, propertyId, checkinDate, checkoutDate, numberOfGuests, bookingStatus);
...
router["delete"]('/:id', _advancedAuth["default"], function (req, res) {
  try {
    var id = req.params.id;
    var deletedBookingsId = (0, _deleteBookings["default"])(id);
