...
var _createHosts = _interopRequireDefault(require("../services/hosts/createHosts.js"));

var _getHostsById = _interopRequireDefault(require("../services/hosts/getHostsById.js"));

var _updateHostsById = _interopRequireDefault(require("../services/hosts/updateHostsById.js"));

var _deleteHosts = _interopRequireDefault(require("../services/hosts/deleteHosts.js"));
...
router.get('/:id', function (req, res) {
  try {
    ...
    var hosts = (0, _getHostsById["default"])(id);
...
router.post('/', _auth["default"], function (req, res) {
  try {
    ...
    var newHosts = (0, _createHosts["default"])(id, username, password, name, email, phoneNumber, profilePicture, aboutMe);
...
router.put('/:id', _auth["default"], function (req, res) {
  try {
    ...
    var updatedHosts = (0, _updateHostsById["default"])(id, username, password, name, email, phoneNumber, profilePicture, aboutMe);
...
router["delete"]('/:id', _auth["default"], function (req, res) {
  try {
    var id = req.params.id;
    var deletedHostsId = (0, _deleteHosts["default"])(id);
