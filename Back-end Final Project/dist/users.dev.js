...
var _createUser = _interopRequireDefault(require("../services/users/createUser.js"));

var _getUserById = _interopRequireDefault(require("../services/users/getUserById.js"));

var _updateUserById = _interopRequireDefault(require("../services/users/updateUserById.js"));

var _deleteUserById = _interopRequireDefault(require("../services/users/deleteUserById.js"));
...
router.get('/', function (req, res) {
  try {
    ...
    console.error(error);
    res.status(404).send('Something went wrong while getting list of users!');
  }
});
router.get('/:id', function (req, res) {
  try {
    var id = req.params.id;
    var users = (0, _getUserById["default"])(id);
...
router.post('/', _auth["default"], function (req, res) {
  try {
    ...
    var newUsers = (0, _createUser["default"])(id, username, password, name, email, phoneNumber, profilePicture);
...
router.put('/:id', _auth["default"], function (req, res) {
  try {
    ...
    var updatedUsers = (0, _updateUserById["default"])(id, username, password, name, email, phoneNumber, profilePicture);
...
router["delete"]('/:id', _auth["default"], function (req, res) {
  try {
    var id = req.params.id;
    var deletedUsersId = (0, _deleteUserById["default"])(id);
