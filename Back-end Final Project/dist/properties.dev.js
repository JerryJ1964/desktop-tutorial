...
var _createProperty = _interopRequireDefault(require("../services/properties/createProperty.js"));

var _getPropertyById = _interopRequireDefault(require("../services/properties/getPropertyById.js"));

var _updatePropertyById = _interopRequireDefault(require("../services/properties/updatePropertyById.js"));

var _deletePropertyById = _interopRequireDefault(require("../services/properties/deletePropertyById.js"));
...
router.get('/:id', function (req, res) {
  try {
    ...
    var properties = (0, _getPropertyById["default"])(id);
...
router.post('/', _auth["default"], function (req, res) {
  try {
    ...
    var newProperties = (0, _createProperty["default"])(id, title, description, location, pricePerNight, bedroomCount, bathRoomCount, maxGuestsCount, hostId, rating);
...
router.put('/:id', _auth["default"], function (req, res) {
  try {
    ...
    var updatedProperties = (0, _updatePropertyById["default"])(id, title, description, location, pricePerNight, bedroomCount, bathRoomCount, maxGuestsCount, hostId, rating);
...
router["delete"]('/:id', _auth["default"], function (req, res) {
  try {
    var id = req.params.id;
    var deletedPropertiesId = (0, _deletePropertyById["default"])(id);
